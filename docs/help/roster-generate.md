...
intent_tags: [generate roster, auto roster, ai roster, build roster automatically, constraints, coverage, unfilled shifts, roster generator, shift templates, hour blocks, add a shift, 3-hour shift, retire a shift]
